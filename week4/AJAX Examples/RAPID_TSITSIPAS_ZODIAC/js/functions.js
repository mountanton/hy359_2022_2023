...
function submit(){
	...
	rapid(zodiacEnglish[zodiacSign]);
}

function rapid(zodiac){
	const data = null;
document.getElementById("rapid").innerHTML="<h2> Info about your Zodiac Sign</h2>";
	...
	xhr.addEventListener("readystatechange", function () {
		if (this.readyState === this.DONE) {
			 ...
			 document.getElementById("rapid").innerHTML+= "<b>"+name.replace("_"," ")+"</b>: "+json[name]+"<br>";
			 }
		}
	});

	xhr.open("POST", "https://sameer-kumar-aztro-v1.p.rapidapi.com/?sign="+zodiac+"&day=today");
